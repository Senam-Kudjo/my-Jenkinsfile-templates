        ...
        stage ('Deploy To SandBox Environment') {
            ...
            steps {
                ...
                script {
                    ...
                    echo "${TAG}"
                    build job: 'gh-argocd-full-auto', parameters: [string(name: 'PORTINGO', value: "${PORTINGO}"),string(name: 'IMAGETAG', value: "${TAG}"), string(name: 'DEPLOYMENT_MANIFEST_NAME', value: "${DEPLOYMENT_MANIFEST_NAME}"), string(name: 'REPOSITORY_NAME', value: "${REPOSITORY_NAME}"), string(name: 'SERVICE_NAME', value: "${SERVICE_NAME}"), string(name: 'ENVIRONMENT', value: 'sandbox')]
                }
            }
        }
